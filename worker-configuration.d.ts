/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7111e504ec245fe6687d03affc43132e)
// Runtime types generated with workerd@1.20260617.1 2026-05-18 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	API_BASE_URL: string;
	PUBLIC_CDN_STATIC_BASE_URL: string;
	PUBLIC_CDN_PROJECT_BASE_URL: string;
	PUBLIC_TEST_LEMONSQUEEZY_PRODUCT_LINK: string;
	PUBLIC_LIVE_LEMONSQUEEZY_PRODUCT_LINK: string;
}
