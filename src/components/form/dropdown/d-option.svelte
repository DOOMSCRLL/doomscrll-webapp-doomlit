<script lang="ts">
	...
	const { label, value, isSelected = false, isHighlighted = false, onSelect }: Props = $props()
</script>
...
<li
	...
	class={[
		...
		"rounded-2xl bg-obverse transition-all duration-150 hover:bg-inverse hover:text-obverse",
